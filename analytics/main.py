...
from object_detection.utils import load_class_names, output_boxes, draw_outputs, resize_image,crop_persons
import cv2
import numpy as np
...
from gender_age.get_gender_age import detect_cropped_imgs
...
class_name = 'object_detection/data/coco.names'
max_output_size = 40
...
cfgfile = 'object_detection/cfg/yolov3.cfg'

weightfile = 'object_detection/weights/yolov3_weights.tf'

img_path = "object_detection/data/images/person.jpg"
